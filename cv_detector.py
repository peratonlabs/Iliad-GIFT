...
def configure(arg_dict):
    ...
    cv_cal(arg_dict, metaParameters["cv_dets"], metaParameters["cv_cls"])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--configure_models_dirpath', type=str, help='Path to a directory containing models to use when in self-tune mode.',default = "./data/round10")
