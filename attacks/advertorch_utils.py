...
def batch_l1_proj(x, eps):
    """
    Implementation of batch L1 ball projection from:
...
def is_float_or_torch_tensor(x):
    """ Checks the instance of the input value
    :param x:
    :return: boolean
    """
