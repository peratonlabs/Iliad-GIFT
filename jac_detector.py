...
# import utils
# import pickle
# from detection.lc_detection import *
from detection.jac_detection import det2
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Lipchitz constant-based detector.')
    ...
    parser.add_argument('--gift_basepath', type=str,
                        ...
                        default='/gift/')
    parser.add_argument('--tokenizer_filepath', type=str, default='')
    parser.add_argument('--embedding_filepath', type=str,default='')

    parser.add_argument('--cls_token_is_first', action="store_true")


    args = parser.parse_args()

    det = det2(train=False, basepath=args.gift_basepath)

    trojan_probability = det(args.model_filepath)[0]
...
# python lc_detector.py --model_filepath test/model.pt --result_filepath --model_filepath test/output